$(document).ready(function ()
{
    $("#fileuploader").uploadFile({
        ...
        onSuccess: function (files, data) {
            ...
            if (data.erro == 0) {
                $("#uploaded_image").append('<ul style="list-style: none; display: inline-block"><li><img src="' + BASE_URL + 'uploads/cursos/' + data.uploaded_data['file_name'] + '" width="80" class="img-thumbnail mb-2 mr-1"><input type="hidden" name="fotos_produtos[]" value="' + data.foto_caminho + '"><a href="javascript:(void)" type="button" class="btn bg-danger d-block btn-icon text-white mx-auto mb-30 btn-remove"><i class="fas fa-times"></i></a></li></ul>');
            } else {
