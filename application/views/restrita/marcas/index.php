                        ...
                        <?php foreach ($marcas as $marca): ?>
                          ...
                          <tr>                      
                              ...
                              <td>
                                ...
                                <a href="<?php echo base_url('restrita/marcas/delete/'.$marca->marca_id);?>" class="btn btn-icon btn-danger delete" data-confirm="Tem certeza da exclusão da escoala?"><i class="fas fa-times"></i></a>
                              </td>
                            </tr>
