                    ...
                    <?php foreach ($produtos as $produto) : ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="<?php echo base_url('restrita/produtos/delete/' . $produto->produto_id); ?>" class="btn btn-icon btn-danger delete" data-confirm="Tem certeza da exclusão do curso?"><i class="fas fa-times"></i></a>
                        </td>
                      </tr>
