<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="<?php echo base_url('public/web/logo.png')?>" class="header-logo" /> <span
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown <?php echo $this->router->fetch_class() == 'usuarios' && $this->router->fetch_method() == 'index' ? 'active' : ''; ?>">
              <a href="<?php echo base_url('restrita/usuarios')?>" class="nav-link"><i data-feather="users"></i><span>Usúarios</span></a>
            </li>
            <li class="dropdown <?php echo $this->router->fetch_class() == 'marcas' && $this->router->fetch_method() == 'index' ? 'active' : ''; ?>">
              <a href="<?php echo base_url('restrita/marcas')?>" class="nav-link"><i data-feather="layers"></i><span>Escolas</span></a>
            </li>
