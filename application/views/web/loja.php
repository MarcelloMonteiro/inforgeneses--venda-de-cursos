                        ...
                        <div class="col-lg-12">
                            <div class="li-product-tab">
                                <ul class="nav li-product-menu">
                                   <li><a class="active" data-toggle="tab" href="#li-new-product"><span>Novos</span></a></li>
                               </ul>               
                            </div>
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="<?php echo base_url('produto/'.$produto->produto_meta_link);?>">
                                                    <img src="<?php echo base_url('uploads/cursos/'.$produto->foto_caminho); ?>" alt="<?php echo $produto->produto_nome;?>">
                                                </a>
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html"><?php echo $produto->produto_nome;?></a></h4>
                                                    <div class="price-box">
